...
function StudyMaterials() {
    ...
    const studyMaterials = [
        { id: 1, name: 'Tài Liệu Ôn Tập Môn Nhập môn lập trình', icon: 'picture_as_pdf' }
    ];
    ...
    // Filter study materials by search term
            ...
            <div className="document-content">
                <div className="document-header">
                    <h1 className="document-breadcrumb">
                        ...
                        <span style={{marginLeft: '8px'}}>Tài Liệu Ôn Tập</span>
                    </h1>
                </div>
                ...
                <div className="materials-list">
                    {filteredMaterials.map(material => (
                        <div key={material.id} className="material-item">
                            <span className="material-icons pdf-icon">{material.icon}</span>
